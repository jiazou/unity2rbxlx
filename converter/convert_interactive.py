...
def _make_pipeline(
    ...
    *,
    ...
    if ctx_path.exists():
        ...
        # Mark as explicit resume so any same-project-only migrations
        # can distinguish a true resume from a fresh convert into a
        # dir that happens to hold leftover artifacts from another
        # project.
